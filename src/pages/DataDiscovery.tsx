    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Tabs defaultValue="organization" className="mb-6">
        <TabsList className="grid grid-cols-7 mb-4">
          <TabsTrigger value="organization">Organizational Overview</TabsTrigger>
          <TabsTrigger value="surface">Surface Exposure</TabsTrigger>
          <TabsTrigger value="vulnerability">Vulnerability Inventory</TabsTrigger>
          <TabsTrigger value="credentials">Credential & Data Leaks</TabsTrigger>
          <TabsTrigger value="technology">Technology Fingerprinting</TabsTrigger>
          <TabsTrigger value="files">Discovered Files</TabsTrigger>
          <TabsTrigger value="news">News Mentions</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="news">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <h2 className="text-xl font-semibold mb-4">News Mentions</h2>
